...
// Conectar ao banco PostgreSQL da VPS usando a DATABASE_URL fornecida
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres:929d54bc0ff22387163f04cfb3b3d0fa@148.230.78.128:5432/postgres';
